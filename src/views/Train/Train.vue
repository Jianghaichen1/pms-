<template>
    <div class="randp">
		...
		<el-menu class="el-menu-demo" mode="horizontal" active-text-color="#E5E5E5">
       	 ...
       	 <el-button  style="background-color: #26DE4C;border-color: #26DE4C ;" type="primary" @click="addTrain">添加</el-button>
		...
		<div class="wrapper">
			<el-table :data="tableData" border>
			 <el-table-column  type="selection" width="55"></el-table-column>
     			 <el-table-column class="Tid"  sortable prop="Tid" label="编号" width="100"  show-overflow-tooltip>
     			 </el-table-column>
				  <el-table-column class="dup"  sortable prop="dup" label="部门" width="100" >
     			 </el-table-column>
				 <el-table-column class="uname"  sortable prop="uname" label="姓名" width="100" >
     			 </el-table-column>
				
      			 <el-table-column  prop="Type" label="培训类型" width="150">
      			 </el-table-column>
				 <el-table-column prop="Tate" sortable  label="签到" width="150" show-overflow-tooltip>
     			 </el-table-column>
				  <el-table-column prop="Tup" label="签到开始时间" width="260">
      			 </el-table-column>

			       <el-table-column prop="Tdown" label="签到结束时间" width="150">
				  </el-table-column>
...
<el-button size="mini" type="danger" @click="handleDelete(scope.$index, scope.row)" icon="el-icon-delete" >删除</el-button>	
		...
		-->
		<TrainDialog ref="dialog" :title="title" :rowData="rowData" />
...
<script >
	...
	methods:{
			...
			handleEdit(index,row){
				...
				this.title = "编辑培训信息";
				this.rowData = { ...row };
      			 this.$refs.dialog.trainForm = row;//方法1：
			},
			//删除
