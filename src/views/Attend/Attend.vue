<template>
    <div class="attend">
		...
		<el-menu class="el-menu-demo" mode="horizontal" active-text-color="#E5E5E5">
       	 ...
       	 <el-button  style="background-color: #26DE4C;border-color: #26DE4C ;" type="primary" @click="addAttend">添加</el-button>
		...
		<div class="wrapper">
			<el-table :data="tableData" border>
			 <el-table-column  type="selection" width="55"></el-table-column>
     			 <el-table-column class="Aid"  sortable prop="Aid" label="编号" width="100"  show-overflow-tooltip>
     			 </el-table-column>
				 <el-table-column class="udp"  sortable prop="udp" label="部门" width="100" >
     			 </el-table-column>
				 	 <el-table-column class="name" prop="name" label="姓名" width="100" >
     			 </el-table-column>
				<el-table-column prop="Aup" sortable  label="开始时间" width="150" show-overflow-tooltip>
     			 </el-table-column>
      			 <el-table-column  prop="Adown" label="结束时间" width="150">
      			 </el-table-column>
			      <el-table-column  prop="type" label="打卡" width="150">
				  </el-table-column>
                
      			 <el-table-column prop="Alocation" label="地点" width="260">
      			 </el-table-column>
...
<el-button size="mini" type="danger" @click="handleDelete(scope.$index, scope.row)" icon="el-icon-delete" >删除</el-button>	
		...
		-->
		<AttendDialog ref="dialog" :title="title" :rowData="rowData" />
...
<script >
	...
	import AttendDialog from './AttendDialog.vue';
	...
	methods:{
			...
			handleEdit(index,row){
				...
				this.title = "编辑考勤信息";
				// this.rowData = { ...row };
      			this.$refs.dialog.attendForm = row;//方法1：
			},
			//删除
